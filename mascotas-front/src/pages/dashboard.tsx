            ...
            <Tooltip>
              <TooltipTrigger asChild>
                ...
                >
                  ...
                  <span className="sr-only">Listado de Mascotas</span>
                </Link>
              </TooltipTrigger>
              <TooltipContent side="right">Listado de Mascotas</TooltipContent>
            </Tooltip>
            <Tooltip>
              <TooltipTrigger asChild>
                <Link
                ...
                >
                  <div className="h-5 w-5" />
                  <span className="sr-only">Agregar Mascota</span>
                </Link>
              </TooltipTrigger>
              <TooltipContent side="right">Agregar Mascota</TooltipContent>
            </Tooltip>
            <Tooltip>
              <TooltipTrigger asChild>
                <Link
